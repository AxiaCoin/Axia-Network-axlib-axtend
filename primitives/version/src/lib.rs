...
pub struct RuntimeVersion {
	/// Identifies the different Axlib runtimes. There'll be at least axiaaxc and node.
	...
	/// codebase, it will be axia-axiaaxc. If there were a non-Rust implementation of the
	/// Axiaaxc runtime (e.g. C++), then it would identify itself with an accordingly different
	/// `impl_name`.

...
//!
//! This module contains primitives used by Axiaaxc implementation of the BEEFY+MMR bridge,
//! but we imagine they will be useful for other chains that either want to bridge with Axiaaxc
//! or are completely standalone, but heavily inspired by Axiaaxc.

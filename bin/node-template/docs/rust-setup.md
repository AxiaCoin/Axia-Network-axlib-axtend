...
Axlib Node Template. Since Axlib is built with
...
in the Axlib [Tutorials](https://docs.axlib.io/tutorials/v3) and 
[How-to Guides](https://docs.axlib.io/how-to-guides/v3) use Unix-style terminals to demonstrate
how to interact with Axlib from the command line.

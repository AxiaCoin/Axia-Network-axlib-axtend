...
You can read more about security and risks in the [Axiaaxc Wiki](https://wiki.axiaaxc.network/docs/learn-account-generation).
The Axiaaxc network has a few **test networks**, e.g. **Alphanet**. Test networks are a great way to experiment and learn safely as you can lose tokens on those networks without any financial consequences.

...
Subkey is a commandline utility included with Axlib. It allows generating and restoring keys for Axlib based chains such as Axiaaxc, AxiaTest and a growing number of allychains and Axlib based projects.
...
You can read more about security and risks in [SECURITY.md](./SECURITY.md) and in the [Axiaaxc Wiki](https://wiki.axiaaxc.network/docs/learn-account-generation).
...
The **SS58 address** (or **Public Address**) of a new account is a reprensentation of the public keys of an account for a given network (for instance AxiaTest or Axiaaxc).
...
- Axiaaxc: `16m4J167Mptt8UXL8aGSAi7U2FnPpPxZHPrCgMG9KJzVoFqM`
...
```bash
subkey vanity --network axiaaxc --pattern bob
```

...
last_version=$(last_github_release 'axiatech/axlib')
...
out=$(curl -s -X POST --data "$data" -H "Authorization: token $GITHUB_RELEASE_TOKEN" "$api_base/axiatech/axlib/releases")

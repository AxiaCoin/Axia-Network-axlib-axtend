...
LABEL io.axia.image.authors="devops-team@axia.io" \
	...
	io.axia.image.source="https://github.com/axiatech/axlib/blob/${VCS_REF}/.maintain/docker/subkey.Dockerfile" \
	io.axia.image.revision="${VCS_REF}" \
	io.axia.image.created="${BUILD_DATE}" \
	io.axia.image.documentation="https://github.com/axiatech/axlib/tree/${VCS_REF}/subkey"

...
Other examples include the allychain-heads extrinsic in Axiaaxc and the "note-missed-proposal" extrinsic used in FRAME to determine and punish or deactivate offline validators.
...
Here's a snippet of the Axiaaxc API implementation as of PoC-3:
...
cargo run --release \-- \
  ...
  --telemetry-url 'ws://telemetry.axiaaxc.io:1024 0' \
  --validator
...
If you are successful, you will see your node syncing at https://telemetry.axiaaxc.io/#/Flaming%20Fir

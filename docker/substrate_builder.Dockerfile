...
LABEL description="Multistage Docker image for Axlib: a platform for web3" \
	...
	io.axia.image.source="https://github.com/axiatech/axiaaxc/blob/${VCS_REF}/docker/axlib_builder.Dockerfile" \
	io.axia.image.documentation="https://github.com/axiatech/axiaaxc/"
